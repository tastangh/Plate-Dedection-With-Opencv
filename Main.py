...
def main():
  ...
  #3  ret, orjinal_resim =cam.read()
    ...
    orjinal_resim  = cv2.imread("arac_listesi/3.jpg")               # open image
    ...
    if len(ihtimal_plaka_listeleri) == 0:                          # if no plates were found
        ...
        print("----------------------------------------")
        a = Plaka.strChars
        plakaliste = open("C:/Users/Taştan/Desktop/çalışmalar/KNN-ile-Plaka-Tespiti-master\KNN-ile-Plaka-Tespiti-master/plaka.txt","a")
        plakaliste.write(a + '\n' )
...
if __name__ == "__main__":
   ...
   # while True:
      #  success, orjinal_resim = cap.read()
      #  main()
       # if cv2.waitKey(30) & 0xff == ord('w'):  # ord is for exit while we type q key
           # break
